...
export const API_CONFIG = {
  ...
  baseUrl:
    import.meta.env.VITE_GS_API_URL ||
    'https://script.google.com/macros/s/AKfycbz3DmnPOLstWmOmJs4nzDQn42XXWe0E2ujLpmfo4e4WZFkInXxUdeL8-W0SImYj9EQj/exec',
  ...
  try {
    ...
    if (typeof window !== 'undefined') {
      ...
      if (!el) {
        ...
        el.style =
          'background:#b91c1c;color:#fff;padding:8px 12px;font-weight:bold;position:fixed;top:0;left:0;right:0;z-index:9999;text-align:center;';
