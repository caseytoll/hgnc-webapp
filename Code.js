...
function doGet(e) {
  // Single-page app with lazy-loaded modules - no multi-page routing needed
 ...
 */
var CDN_TAG = '@dafbd1e';  // Updated to current HEAD with all assets; production releases pin to commit SHA
