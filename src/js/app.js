// DEPRECATED: legacy/ghost copy of the app.
// This file is retained for historical/reference purposes only and is NOT used by the current build.
// Do NOT edit this file for active development — update `apps/coach-app/src/js/app.js` instead.
...
const state = {
  dataSource: API_CONFIG.useMockData ? 'mock' : 'api',
  teams: [],
  currentTeam: null,
