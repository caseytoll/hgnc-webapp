...
- The GitHub Action runs on Node 20 and will **fetch ladders for all teams** returned by `getTeams`, commit changed `public/ladder-*.json` to `master`, and trigger a Cloudflare Pages redeploy.
